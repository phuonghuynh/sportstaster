 ...
 */
@Controller("blBraintreePaymentGatewayHostedController")
@RequestMapping("/" + BraintreePaymentGatewayConstants.GATEWAY_CONTEXT_KEY)
public class BraintreePaymentGatewayHostedController extends PaymentGatewayAbstractController {
  ...
  public String getGatewayContextKey() {
    return BraintreePaymentGatewayConstants.GATEWAY_CONTEXT_KEY;
  }
